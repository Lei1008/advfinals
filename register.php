        ...
        if (empty(trim($_POST['username']))) {
            ...
            if ($statement) {
                ...
                if (mysqli_stmt_execute($statement)) {
                    ...
                    }else if(preg_match('/[^a-zA-Z0-9]/i', $_POST['username'])) {
                        $usernameErr = 'Username should only consist alphanumeric characters.';

                    }else if(strlen($_POST['username']) >= 10){
                        $usernameErr = 'Username should only consist maximum of 10 characters.';
                    }else {
